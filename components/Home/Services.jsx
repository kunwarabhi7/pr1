...
const Services = ({ imageUrl, title }) => {
  return (
    <div id="services" className="max-w-sm mx-auto   overflow-hidden shadow-lg rounded-lg cursor-pointer transition ease-in-out delay-150 hover:translate-y-1 hover:scale-105 duration-200">
